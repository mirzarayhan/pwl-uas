...
class petugaspajak extends REST_Controller
{

	public function __construct()
    {
        parent::__construct();
        $this->load->model('Petugaspajak_model', 'petugas');
    ...
    public function index_delete()
    {
        ...
        if ($id === null) {
            ...
            if ($this->petugas->hapusdataptgp($id)>0) {
                $this->response([
                    'status' => TRUE,
                    'id' => $id,
                    'message' => 'terhapus'
    ...
    public function index_post()
    {
        ...
        if ($this->petugas->tambahdataptgp($data)>0) {
            $this->response([
                'status' => TRUE,
    ...
    public function index_put()
    {
        ...
        if ($this->petugas->ubahptgp($data, $id)>0) {
            $this->response([
                'status' => TRUE,
